class Aufzug():
    ...
    def aussteigenPerson(self,person):
        ...
        elif self.aktuelleAnzahlPersonen < 0:
    ...
    def hochfahren(self,etage):
        ...
        if self.aktuelleEtage < self.höchsteEtage:
            print("hochfahren","Der Aufzug befinded sich auf der ",self.aktuelleEtage,"Etage")
        elif self.aktuelleEtage> self.höchsteEtage:###
    ...
    def runterfahren(self,etage):
        ...
        elif self.aktuelleEtage< self.tiefsteEtage:
            print("Es gibt keine Etagen mehr !")
            self.aktuelleEtage +=etage

    def info(self):
        print("Aufzug Info")
        print("Der Aufzug befinded sich auf der ",self.aktuelleEtage,"Etage")
        print("Es ist(sind) nur ",self.aktuelleAnzahlPersonen,"Person(en) im Aufzug")
